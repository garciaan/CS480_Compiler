...
static std::string parse_table_rules[] = {
	...
	"NON_S_2:STDOUT:NON_STMT_1,NON_S_1,",
	...
	"NON_STMT_1:LET:LET,L_BRACKET,NON_VARLIST,R_BRACKET,R_BRACKET,",
	...
	//Ifstmt rules
	"NON_IFSTMT:L_BRACKET:NON_EXPR,R_BRACKET,",
	"NON_IFSTMT:ID:NON_EXPR,R_BRACKET,",
	"NON_IFSTMT:CONST_ALL:R_BRACKET,",
